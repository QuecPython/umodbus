...
class Modbus(object):
    def __init__(self, itf, addr_list: list):
        ...
        # registers which can be set by remote channel
    ...
    def remove_coil(self, address: int):
        """
    ...
    def add_hreg(self, address: int, value: Union[int, List[int]] = 0):
        """
    ...
    def remove_hreg(self, address: int):
        """
    ...
    def set_hreg(self, address: int, value: Union[int, List[int]] = 0):
        """
    ...
    def remove_ist(self, address: int):
        """
        Remove a holding register from the modbus register dictionary.
    ...
    def set_ist(self, address: int, value: bool = False):
        """
    ...
    def add_ireg(self, address: int, value: Union[int, List[int]] = 0):
        """
    ...
    def remove_ireg(self, address: int):
        """
    ...
    def set_ireg(self, address: int, value: Union[int, List[int]] = 0):
        """
    ...
    def _get_regs_of_dict(self, reg_type: str):
        """
    ...
    def _check_valid_register(self, reg_type: str):
        """
    ...
    def _create_response(self, request, reg_type):
        """
        Create a response.
